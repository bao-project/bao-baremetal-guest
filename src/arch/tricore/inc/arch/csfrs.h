...
CSFRS_GEN_ACCESSORS_NAMED(ccnt, CSFR_CCNT)
CSFRS_GEN_ACCESSORS_NAMED(cctrl, CSFR_CCTRL)
...
#define CSFR_GEN_PR_READ(M, R)                                       \
    static inline unsigned long csfr_##M##pr_##R##_read(uint32_t id) \
    {                                                                \
        switch (id) {                                                \
...
#define CSFR_GEN_PR_WRITE(M, R)                                                 \
    static inline void csfr_##M##pr_##R##_write(uint32_t id, unsigned long val) \
    {                                                                           \
        switch (id) {                                                           \
...
#define GEN_P_ACCESSOR(m)                                                       \
    ...
    static inline bool get_##m##_bit(unsigned long psid, uint32_t mpid)         \
    {                                                                           \
        return !!(get_##m(psid) & (1UL << mpid));                               \
    }                                                                           \
    static inline void set_##m##_bit(unsigned long psid, uint32_t mpid, bool b) \
    {                                                                           \
