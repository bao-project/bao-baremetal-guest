...
#define PTE_MEM_FLAGS    (PTE_OI_WB_RA_WA | PTE_A | PTE_AP_RW_PRIV | PTE_DOMAIN(0) | PTE_S)
#define PTE_DEV_FLAGS    (PTE_DEVnGnRnE | PTE_A | PTE_AP_RW_PRIV | PTE_DOMAIN(0) | PTE_S)
