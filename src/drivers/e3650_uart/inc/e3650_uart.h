...
/* FSR1: FIFO Status Register 1 */
#define FSR1_EMPTY              (1u << 24)  /* RX FIFO Empty Flag */

/* INTEN0: Interrupt Enable Register 0 */
#define INTEN0_RXFWF            (1u << 1)   /* RX FIFO Watermark Full Interrupt Enable */

/* INTR0: Interrupt Status Register 0 */
#define INTR0_RXFWF             (1u << 1)   /* RX FIFO Watermark Full Interrupt Status */
