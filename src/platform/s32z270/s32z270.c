...
const struct mpu_region plat_mpu_regs[] = {
    MPU_REGION_DESC(RO_MEM_BASE, RO_MEM_SIZE, PRBAR_SH_IS, PRBAR_AP_RW_ALL, PRBAR_ATTR_NORMAL),
    MPU_REGION_DESC(RW_MEM_BASE, RW_MEM_SIZE, PRBAR_SH_OS, PRBAR_AP_RW_ALL, PRBAR_ATTR_NORMAL),
    MPU_REGION_DESC(PLAT_DEV_MEM_BASE, PLAT_DEV_MEM_SIZE, PRBAR_SH_IS, PRBAR_AP_RW_ALL,
        PRBAR_ATTR_DEVICE),
#if SHMEM_SIZE > 0
    MPU_REGION_DESC(SHMEM_BASE, SHMEM_SIZE, PRBAR_SH_OS, PRBAR_AP_RW_ALL, PRBAR_ATTR_NORMAL),
#endif
};
